...
const prizeValues = ["R$ 200", "R$ 100", "R$ 50", "R$ 50", "R$ 50", "R$ 50"];
        ...
        <div className="md:flex md:flex-row-reverse justify-between items-start gap-8">
          ...
          <div className="mt-6 md:mt-0">
              ...
              <ul className="[&>li]:mt-3 list-disc list-inside">
                <li>
                  ...
                  <ul className="ml-6 list-disc list-inside">
                    ...
                    <li>Todos jogam contra todos em melhor de 3</li>
                    <li>Vitória por 2x0 vale 3 pontos</li>
                    <li>Vitória por 2x1 vale 2 pontos</li>
                    <li>
                ...
                <li>
                  ...
                  <ul className="ml-6 list-disc list-inside">
                    ...
                    <li>
                      Todas as partidas das Chaves dos Vencedores e Perdedores
                      serão melhor de 5
                    </li>
                    <li>A Grande Final será melhor de 9</li>
                  </ul>
                </li>
              </ul>
            </div>
            ...
            <div className="mt-6">
              ...
              <Separator />
              <p className="mt-3">O prêmio base é R$ 500.</p>
              <p>
                  ...
                  <div key={bracket.bracket_type} className="flex">
                    {bracket.cup_playoffs.map((playoff) => (
                      <div
                        ...
                        className="first:ml-[256px] ml-[286px]"
                      >
                                ...
                                <div className="relative w-fit">
                                  ...
                                  {playoff.order === 3 && (
                                    <>
                                      ...
                                      <div className="absolute top-[362.5%] -right-10 translate-x-full w-8 h-0.5 bg-muted" />
                                    </>
                                  )}
                                </div>
                              </div>
  ...
  for (const round of group.cup_rounds) {
    for (const match of round.cup_matches) {
      ...
      if (playerOneWins > playerTwoWins) {
        const points = playerTwoWins === 0 ? 3 : 2;
        playerPoints[playerOneId] = (playerPoints[playerOneId] || 0) + points;
      } else if (playerTwoWins > playerOneWins) {
        const points = playerOneWins === 0 ? 3 : 2;
        playerPoints[playerTwoId] = (playerPoints[playerTwoId] || 0) + points;
      }
    }
  }
