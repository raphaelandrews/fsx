...
} from "@/components/animate-ui/counting-number";
...
function ProgressTrack({
  ...
  return (
    <ProgressPrimitives.Track
      ...
      className={cn(
        "relative h-3 w-full overflow-hidden rounded-xs bg-secondary",
        className
      )}
      {...props}
    >
      <MotionProgressIndicator
        ...
        className="h-full w-full flex-1 bg-primary rounded-xs"
        animate={{ width: `${value}%` }}
        transition={transition}
      />
    </ProgressPrimitives.Track>
