...
function ManagementBar() {
	...
	return (
		<div className="-translate-x-1/2 fixed bottom-20 left-1/2 flex w-fit flex-wrap items-center gap-y-2 rounded-2xl border border-border bg-background p-2 shadow-lg">
