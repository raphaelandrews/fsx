...
export const playersToInsignias = pgTable(
...
export const playersToInsigniaRelations = relations(
	playersToInsignias,
	({ one }) => ({
		player: one(players, {
...
export const insertPlayerToInsigniaSchema =
	createInsertSchema(playersToInsignias)
