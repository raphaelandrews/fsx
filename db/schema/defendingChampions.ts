...
export const defendingChampions = pgTable(
	"defending_champions",
	{
...
export const defendingChampionsRelations = relations(
	defendingChampions,
	({ one }) => ({
		player: one(players, {
...
export const insertDefendingChampionSchema =
	createInsertSchema(defendingChampions)
