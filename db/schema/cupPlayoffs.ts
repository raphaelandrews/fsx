...
export const phaseTypeEnum = pgEnum("phase_type", [
	"Oitavas Chave Superior",
	"Quartas Chave Superior",
	"Semis Chave Superior",
	"Final Chave Superior",
	"Grande Final",
	"Chave Inferior Round 1",
	"Chave Inferior Round 2",
	"Chave Inferior Round 3",
	"Chave Inferior Round 4",
	"Quartas Chave Inferior",
	"Semis Chave Inferior",
