...
export const tournamentPodiums = pgTable(
	"tournament_podiums",
	{
...
export const tournamentPodiumsRelations = relations(
	tournamentPodiums,
	({ one }) => ({
		player: one(players, {
...
export const insertTournamentPodiumSchema =
	createInsertSchema(tournamentPodiums)
