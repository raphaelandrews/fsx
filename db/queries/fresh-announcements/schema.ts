...
export const APIFreshAnnouncementsResponseSchema = z.discriminatedUnion(
	"success",
	[
		z.object({
...
export type APIFreshAnnouncementsResponse = z.infer<
	typeof APIFreshAnnouncementsResponseSchema
>
