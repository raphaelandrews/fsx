...
function getBirthDateRange(group: string): [Date, Date] | undefined {
	...
	switch (group) {
		case "sub-8":
			return [new Date(year - 8, 0, 1), new Date(year, 11, 31)]
		case "sub-10":
			return [new Date(year - 10, 0, 1), new Date(year - 9, 11, 31)]
		case "sub-12":
			return [new Date(year - 12, 0, 1), new Date(year - 11, 11, 31)]
		case "sub-14":
			return [new Date(year - 14, 0, 1), new Date(year - 13, 11, 31)]
		case "sub-16":
			return [new Date(year - 16, 0, 1), new Date(year - 15, 11, 31)]
		case "sub-18":
			return [new Date(year - 18, 0, 1), new Date(year - 17, 11, 31)]
		case "master":
			return [new Date(year - 50, 0, 1), new Date(year - 40, 11, 31)]
		case "veterano":
			return [new Date(year - 64, 0, 1), new Date(year - 51, 11, 31)]
		case "senior":
			return [new Date(1900, 0, 1), new Date(year - 65, 11, 31)]
		default:
			return
	}
}
