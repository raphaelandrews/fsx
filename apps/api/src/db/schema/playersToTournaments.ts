...
import { integer, pgEnum, pgTable, serial, smallint, uniqueIndex } from "drizzle-orm/pg-core"

import { players, tournaments } from "./index";

export const ratingTypeEnum = pgEnum('rating_type', ['blitz', 'rapid', 'classic']);
...
export const playersToTournaments = pgTable("players_to_tournaments", {
  ...
  (t) => ({
    playerTournament: uniqueIndex("player_tournament").on(t.playerId, t.tournamentId),
  }),
);
