...
import { TitulacaoGuidelines } from "./titulacao-guidelines";
...
export const titulations = [
  {
    ...
    content: (
      <TitulacaoGuidelines
        intro={<p>Obterá o título de GRANDE MESTRE SERGIPANO o enxadrista que:</p>}
        requirements={
          <>
            <p>1. Atingir 2400 de rating FSX em qualquer ritmo.</p>
            <div>
              <p>
                2. Figurar entre os 3 primeiros colocados, ao menos quatro vezes, na categoria
                Absoluto de algum dos seguintes campeonatos:
              </p>
              <div className="mt-2 ml-6 space-y-1 text-muted-foreground">
                ...
                <p>• Campeonatos aprovados pela diretoria da FSX para compor norma</p>
              </div>
            </div>
            <p>
              3. Conquistar por duas vezes o Campeonato Sergipano Absoluto ou conquistar três
              títulos nos campeonatos listados acima.
            </p>
          </>
        }
        note={
          <p>Para a obtenção da titulação, é obrigatório cumprir o item 1, além do item 2 ou 3.</p>
        }
      />
    ),
  },
  {
    ...
    content: (
      <TitulacaoGuidelines
        intro={<p>Obterá o título de MESTRE SERGIPANO, o enxadrista que:</p>}
        requirements={
          <>
            <p>1. Atingir 2300 de rating FSX em qualquer ritmo.</p>
            <p>
              2. Figurar entre os 3 primeiros colocados, ao menos duas vezes nos campeonatos
              listados no item 2 da titulação de GMS.
            </p>
            <p>
              3. Conquistar o Campeonato Sergipano Absoluto ou conquistar dois títulos nos
              campeonatos listados no item 2 da titulação de GMS.
            </p>
          </>
        }
        note={
  ...
  },
  {
    ...
    content: (
      <TitulacaoGuidelines
        intro={<p>Obterá o título de CANDIDATO A MESTRE SERGIPANO o enxadrista que:</p>}
        requirements={
          <>
            <p>1. Atingir 2200 de rating FSX em qualquer ritmo.</p>
            <p>
              2. Figurar entre os 5 primeiros colocados, ao menos uma vez, na categoria Absoluto dos
              campeonatos listados no item 2 da titulação de GMS.
            </p>
          </>
        }
        note={<p>É necessário cumprir ambos os itens 1 e 2 para a obtenção da titulação.</p>}
      />
    ),
  },
  {
    ...
    content: (
      <TitulacaoGuidelines
        intro={<p>Obterá o título de MESTRE JÚNIOR SERGIPANO o enxadrista que:</p>}
        requirements={
          <>
  ...
  },
  {
    ...
    content: (
      <TitulacaoGuidelines
        intro={<p>Obterá o título de MESTRE MIRIM SERGIPANO o enxadrista que:</p>}
        requirements={
          <>
  ...
  },
  {
    ...
    content: (
      <TitulacaoGuidelines
        intro={<p>Obterá o título de MESTRE FEMININA SERGIPANA a enxadrista que:</p>}
        requirements={
          <>
  ...
  },
  {
    ...
    content: (
      <TitulacaoGuidelines
        intro={<p>Obterá o título de MESTRE SERGIPANO HONORIS CAUSA o enxadrista que:</p>}
        requirements={<p>Contribuiu ativamente para a promoção do xadrez no estado de Sergipe.</p>}
        note={
          <p>
            A avaliação para conceder a referida titulação ficará a critério dos membros que compõem
            a diretoria da Federação Sergipana de Xadrez.
          </p>
        }
      />
    ),
