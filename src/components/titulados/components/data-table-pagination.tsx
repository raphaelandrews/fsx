    ...
    <div className="flex items-center justify-end">
      ...
      <div className="flex flex-col sm:flex-row items-end sm:items-center space-y-3 sm:space-y-0 sm:space-x-6 lg:space-x-8">
        <div className="flex items-center space-x-2">
          ...
          <ClientOnly
            fallback={
              <div className="h-8 w-[70px] rounded-md border border-input bg-background px-3 py-1 text-sm">
                <span className="text-muted-foreground">{`${table.getState().pagination.pageSize}`}</span>
              </div>
            }
          >
            <Select
